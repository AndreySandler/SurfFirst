...
case "Красный" where filling == "Шоколад":
    print("Положите в первую кучку")
case "Желтый" where filling == "Орехи":
    print("Положите во вторую кучку")
case "Коричневый" where filling == "Шоколад",
    "Зеленый" where filling == "Шоколад":
    print("Положите в третью кучку")
default:
    print("Возьмите конфетку пожалуйста")
}
