...
for _ in 1...10 {
    ...
    let randomSurnames = surnames.randomElement() ?? ""
    let randomSalary = Int.random(in: 1000...2000)
    
    employees.append(Employee(salary: randomSalary, name: randomNames, surname: randomSurnames))
}
...
for _ in 1...10 {
    ...
    if randomSalary % 2 == 0 {
        employeesWithEvenSalary.append(Employee(salary: randomSalary, name: randomNames, surname: randomSurnames))
    }
}
